...
for columnname = ["subj", "chan", "task", "X", "Y", "Z", "dof", "responseTr", "Loc_Tval", "Loc_Pval", "avg", "time", "RT", "varRT", "JPAnatomy", "Density", "BDI", "BDA", "absX", "DOEvsDOI"]% loop over the column names
